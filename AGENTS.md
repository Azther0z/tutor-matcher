...
- For AUTH-4 in the current Sprint, represent the government ID and teaching certification as URLs; a complete submission grants the Tutor capability immediately while SAFE-2 admin review is deferred; defer normal file upload and document storage to the next Sprint.
