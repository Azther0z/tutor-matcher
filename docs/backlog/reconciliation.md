...
| AUTH-2  | ✅     |                                                                                                                                                                                                                                                                                                         |
| AUTH-3  | ✅     |                                                                                                                                                                                                                                                                                                         |
| AUTH-4  | ✏️     | The applicant is a **logged-in student** and submission requires an ID URL, a certification URL, **and** a bio. For the current sprint, a complete submission grants the Tutor capability immediately because SAFE-2 is deferred; `PENDING` and `REJECTED` remain for the future admin-review workflow. |
