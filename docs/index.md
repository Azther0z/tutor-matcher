...
| [`domain-driven-design.md`](domain-driven-design.md)                 | EventStorming flow, domain building blocks, bounded contexts, subdomains, and hotspots  | Proposed domain model                        |
